...
cd /home/kendrick/antivibe/ruflo/v3/@claude-flow/shared && npm run build 2>&1 | tail -30
...
claude mcp add ruflo -- node /home/kendrick/antivibe/ruflo/v3/@claude-flow/cli/bin/cli.js mcp start